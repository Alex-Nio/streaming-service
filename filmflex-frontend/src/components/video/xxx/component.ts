...
import { createPlayer, createPlayerState, propKeys } from './../player2';
import { PlayerState, PlayerResult } from './../player2';
import {
  normalizedProps,
  normalizedEvents,
  bindPropUpdateEvent
...
export default defineComponent({
  ...
  setup(props, context) {
    ...
    return () => {
      return h(
        'div',
        { 'data-vjs-player': '', class: normalizeClass(initClassName) },
        [
          h('video', {
